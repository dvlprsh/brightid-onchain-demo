      ...
      <Paper className={classes.container} elevation={0} square={true}>
        <Box className={classes.content}>
          ...
          <Typography variant="body1" sx={{ mb: 4 }}>
            ...
            through several conditions, the user can join “brightidOnchain” on-chain
            group.
            ...
            )<h3>Mint NFT</h3>A user with a group membership of “brightidOnchain” can
            mint the NFT badge for the group “brightidOnchain” only once. Please note
